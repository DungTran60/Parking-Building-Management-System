 ...
 *
 * Các reservation PENDING/CONFIRMED có startAt đã quá GRACE_PERIOD_MINUTES mà chưa
 * check-in sẽ bị chuyển sang EXPIRED và slot (nếu đang RESERVED) được giải phóng về AVAILABLE.
 *
 * Chạy mặc định mỗi 5 phút (override bằng property app.reservation-expire-interval-ms).
 */
@Component
