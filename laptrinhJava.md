1.Topic: Hệ thống quản lý tòa nhà gửi xe.

2.Context: Tại các đô thị lớn, nhu cầu gửi xe tăng cao trong khi diện tích đỗ xe bị giới hạn. Tòa nhà gửi xe nhiều tầng là công trình chuyên dùng để tiếp nhận, lưu giữ và tổ chức xe ra/vào theo nhiều tầng hoặc khu vực đỗ khác nhau. Vì lưu lượng xe ra vào liên tục, cần có hệ thống phần mềm hỗ trợ quản lý vận hành bãi xe chính xác và hiệu quả.

3.Problems: Nghiệp vụ tòa nhà gửi xe cần quản lý tốt các vấn đề như xe vào/ra, chỗ đỗ còn trống, vé gửi xe, phí gửi xe và các tình huống phát sinh như mất vé, quá hạn hoặc sai thông tin xe. Nếu quản lý thủ công, bãi xe dễ bị ùn ứ tại cổng, sai lệch dữ liệu, khó kiểm soát sức chứa và khó đối soát doanh thu.

4.Primary Actors: Parking Facility Manager
                Parking Staff
                Parking User / Driver
                System Administrator.

5.Functional Requirements: Parking Manager
...
6.Research Questions: RQ1: Việc phân tầng, khu vực theo loại phương tiện ảnh hưởng thế nào đến hiệu quả sử dụng chỗ đỗ?
